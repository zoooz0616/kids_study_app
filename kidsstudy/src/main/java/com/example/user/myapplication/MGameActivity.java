...
public class MGameActivity extends AppCompatActivity {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissionResult != PackageManager.PERMISSION_GRANTED) {
                ...
                if (shouldShowRequestPermissionRationale(Manifest.permission.RECORD_AUDIO)) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(MGameActivity.this);
                    dialog.setTitle("권한이 필요합니다.")
                            ...
                            .setNegativeButton("아니요", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(MGameActivity.this, "기능을 취소했습니다.", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .create()
                            .show();
    ...
    public void btnclicked(View v) {
        if (checkSelfPermission(Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(MGameActivity.this, "권한이 없어 게임을 할 수 없습니다.", Toast.LENGTH_SHORT).show();
        }else {
            Intent intent = new Intent(this, MGameActivity1.class);
    ...
    public void btnclicked2(View v) {
        if (checkSelfPermission(Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intent = new Intent(this, MGameActivity2.class);
            startActivity(intent);
        }
    }
    ...
    public void btnclicked3(View v) {
        if (checkSelfPermission(Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intent = new Intent(this, MGameActivity3.class);
            startActivity(intent);
        }
    }
}
