...
public class GameActivity2 extends AppCompatActivity implements View.OnClickListener{
    ...
    private String answerWord[] = new String[6];
    ...
    public void onBackPressed() {
        Toast.makeText(GameActivity2.this, "게임 중에는 뒤로 갈 수 없습니다..", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer c = new CountDownTimer(60 * 1000, 1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent (GameActivity2.this, LoseActivity.class);
        ...
        answerButton.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(answerInput.getText().toString().length() == 0){
                    Toast.makeText(GameActivity2.this,"정답을 입력하세요!", Toast.LENGTH_SHORT).show();
                }else if(answerInput.getText().toString().equals(finalAnswer)){
                    Toast.makeText(GameActivity2.this,"정답입니다!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent (GameActivity2.this, WinActivity.class);
                    intent.putExtra("score",  (counter * 10)+"");
                    startActivity(intent);
                }else{
                    Toast.makeText(GameActivity2.this,"정답이 아닙니다!", Toast.LENGTH_SHORT).show();
                    switch (heartIdx){
                        case 1:
    ...
    static class RecognitionHandler extends Handler {
        private final WeakReference<GameActivity2> mActivity;

        RecognitionHandler(GameActivity2 activity) {
            mActivity = new WeakReference<GameActivity2>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            GameActivity2 activity = mActivity.get();
            if (activity != null) {
