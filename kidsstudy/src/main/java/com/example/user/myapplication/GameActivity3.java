...
//import com.example.user.myapplication.NaverRecognizer;
...
public class GameActivity3 extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String TAG = GameActivity3.class.getSimpleName();
    private static final String CLIENT_ID = "68powl1xlb";

    private RecognitionHandler handler;
    private NaverRecognizer naverRecognizer;
    private String answerWord[] = new String[8];
    ...
    public void onBackPressed() {
        Toast.makeText(GameActivity3.this, "게임 중에는 뒤로 갈 수 없습니다..", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer c = new CountDownTimer(60 * 1000, 1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent (GameActivity3.this, LoseActivity.class);
        ...
        answerWord[4] = (String)button[4].getText();
        answerWord[5] = (String)button[5].getText();
        answerWord[6] = (String)button[6].getText();
        answerWord[7] = (String)button[7].getText();
        ...
        answerButton.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(answerInput.getText().toString().length() == 0){
                    Toast.makeText(GameActivity3.this,"정답을 입력하세요!", Toast.LENGTH_SHORT).show();
                }else if(answerInput.getText().toString().equals(finalAnswer)){
                    Toast.makeText(GameActivity3.this,"정답입니다!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent (GameActivity3.this, WinActivity.class);
                    intent.putExtra("score",  (counter * 10)+"");
                    startActivity(intent);
                }else{
                    Toast.makeText(GameActivity3.this,"정답이 아닙니다!", Toast.LENGTH_SHORT).show();
                    switch (heartIdx){
                        case 1:
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.button4:
                ...
                break;
            case R.id.button5:
                nowAnswer = answerWord[4];
                btnNum = 4;
                break;
            case R.id.button6:
                nowAnswer = answerWord[5];
                btnNum = 5;
                break;
            case R.id.button7:
                nowAnswer = answerWord[6];
                btnNum = 6;
                break;
            case R.id.button8:
                nowAnswer = answerWord[7];
                btnNum = 7;
                break;
        }
    ...
    static class RecognitionHandler extends Handler {
        private final WeakReference<GameActivity3> mActivity;

        RecognitionHandler(GameActivity3 activity) {
            mActivity = new WeakReference<GameActivity3>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            GameActivity3 activity = mActivity.get();
            if (activity != null) {
